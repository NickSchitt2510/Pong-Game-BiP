...
public void shrinkBats() {
  ...
  int newLen1 = len2 - min(PApplet.parseInt(s1) / 5 * 20, 60);
  int newLen2 = len1 - min(PApplet.parseInt(s2) / 5 * 20, 60);
  a1.w = newLen1;
  a2.w = newLen2;
  bat1Level = (bat1Level < 3 ? PApplet.parseInt(s1) / 5 : 3);
  bat2Level = (bat1Level < 3 ? PApplet.parseInt(s2) / 5 : 3);
}
